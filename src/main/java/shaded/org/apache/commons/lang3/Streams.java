...
import shaded.org.apache.commons.lang3.Functions.FailableConsumer;
import shaded.org.apache.commons.lang3.Functions.FailableFunction;
import shaded.org.apache.commons.lang3.Functions.FailablePredicate;
 ...
 *
 * @see Stream
 * @see shaded.org.apache.commons.lang3.Functions
 * @since 3.10
 * @deprecated Use {@link shaded.org.apache.commons.lang3.stream.Streams}.
 */
@Deprecated
public class Streams {
     ...
     * @deprecated Use {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream}.
     */
    @Deprecated
    public static class FailableStream<O> {
        ...
        public FailableStream<O> filter(final FailablePredicate<O, ?> predicate){
            assertNotTerminated();
            stream = stream.filter(shaded.org.apache.commons.lang3.Functions.asPredicate(predicate));
            return this;
        }
        ...
        public void forEach(final FailableConsumer<O, ?> action) {
            makeTerminated();
            stream().forEach(shaded.org.apache.commons.lang3.Functions.asConsumer(action));
        }
        ...
        public <R> FailableStream<R> map(final FailableFunction<O, R, ?> mapper) {
            assertNotTerminated();
            return new FailableStream<>(stream.map(shaded.org.apache.commons.lang3.Functions.asFunction(mapper)));
        }
        ...
        public boolean allMatch(final FailablePredicate<O, ?> predicate) {
            assertNotTerminated();
            return stream().allMatch(shaded.org.apache.commons.lang3.Functions.asPredicate(predicate));
        }
     ...
     * @deprecated Use {@link shaded.org.apache.commons.lang3.stream.Streams.ArrayCollector}.
     */
    @Deprecated
