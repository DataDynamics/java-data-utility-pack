...
public class FastTimeZone {
    ...
    private static final TimeZone GREENWICH = new shaded.org.apache.commons.lang3.time.GmtTimeZone(false, 0, 0);
    ...
    public static TimeZone getGmtTimeZone(final String pattern) {
        ...
        if (m.matches()) {
            ...
            return new shaded.org.apache.commons.lang3.time.GmtTimeZone(parseSign(m.group(1)), hours, minutes);
        }
        return null;
    }
