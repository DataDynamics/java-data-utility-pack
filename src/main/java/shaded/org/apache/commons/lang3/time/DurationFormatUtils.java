...
public class DurationFormatUtils {
    ...
    public static String formatDuration(final long durationMillis, final String format, final boolean padWithZeros) {
        shaded.org.apache.commons.lang3.Validate.inclusiveBetween(0, Long.MAX_VALUE, durationMillis, "durationMillis must not be negative");
        ...
        if (Token.containsTokenWithValue(tokens, d)) {
            days = milliseconds / shaded.org.apache.commons.lang3.time.DateUtils.MILLIS_PER_DAY;
            milliseconds = milliseconds - (days * shaded.org.apache.commons.lang3.time.DateUtils.MILLIS_PER_DAY);
        }
        if (Token.containsTokenWithValue(tokens, H)) {
            hours = milliseconds / shaded.org.apache.commons.lang3.time.DateUtils.MILLIS_PER_HOUR;
            milliseconds = milliseconds - (hours * shaded.org.apache.commons.lang3.time.DateUtils.MILLIS_PER_HOUR);
        }
        if (Token.containsTokenWithValue(tokens, m)) {
            minutes = milliseconds / shaded.org.apache.commons.lang3.time.DateUtils.MILLIS_PER_MINUTE;
            milliseconds = milliseconds - (minutes * shaded.org.apache.commons.lang3.time.DateUtils.MILLIS_PER_MINUTE);
        }
        if (Token.containsTokenWithValue(tokens, s)) {
            seconds = milliseconds / shaded.org.apache.commons.lang3.time.DateUtils.MILLIS_PER_SECOND;
    ...
    public static String formatDurationWords(
        ...
        if (suppressLeadingZeroElements) {
            ...
            duration = " " + duration;
            String tmp = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 days", shaded.org.apache.commons.lang3.StringUtils.EMPTY);
            if (tmp.length() != duration.length()) {
                duration = tmp;
                tmp = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 hours", shaded.org.apache.commons.lang3.StringUtils.EMPTY);
                if (tmp.length() != duration.length()) {
                    duration = tmp;
                    tmp = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 minutes", shaded.org.apache.commons.lang3.StringUtils.EMPTY);
                    duration = tmp;
                }
            }
            if (!duration.isEmpty()) {
        ...
        if (suppressTrailingZeroElements) {
            String tmp = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 seconds", shaded.org.apache.commons.lang3.StringUtils.EMPTY);
            if (tmp.length() != duration.length()) {
                duration = tmp;
                tmp = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 minutes", shaded.org.apache.commons.lang3.StringUtils.EMPTY);
                if (tmp.length() != duration.length()) {
                    ...
                    tmp = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 0 hours", shaded.org.apache.commons.lang3.StringUtils.EMPTY);
                    if (tmp.length() != duration.length()) {
                        duration = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(tmp, " 0 days", shaded.org.apache.commons.lang3.StringUtils.EMPTY);
                    }
                }
            }
        }
        // handle plurals
        duration = " " + duration;
        duration = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 1 seconds", " 1 second");
        duration = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 1 minutes", " 1 minute");
        duration = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 1 hours", " 1 hour");
        duration = shaded.org.apache.commons.lang3.StringUtils.replaceOnce(duration, " 1 days", " 1 day");
    ...
    private static String paddedValue(final long value, final boolean padWithZeros, final int count) {
        ...
        return padWithZeros ? shaded.org.apache.commons.lang3.StringUtils.leftPad(longString, count, '0') : longString;
    }
