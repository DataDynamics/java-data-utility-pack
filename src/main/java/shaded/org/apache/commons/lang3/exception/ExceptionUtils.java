...
public class ExceptionUtils {
    ...
    public static String[] getDefaultCauseMethodNames() {
        return shaded.org.apache.commons.lang3.ArrayUtils.clone(CAUSE_METHOD_NAMES);
    }
    ...
    public static String getMessage(final Throwable th) {
        if (th == null) {
            return shaded.org.apache.commons.lang3.StringUtils.EMPTY;
        }
        final String clsName = ClassUtils.getShortClassName(th, null);
        return clsName + ": " + shaded.org.apache.commons.lang3.StringUtils.defaultString(th.getMessage());
    }
    ...
    public static String[] getRootCauseStackTrace(final Throwable throwable) {
        return getRootCauseStackTraceList(throwable).toArray(shaded.org.apache.commons.lang3.ArrayUtils.EMPTY_STRING_ARRAY);
    }
