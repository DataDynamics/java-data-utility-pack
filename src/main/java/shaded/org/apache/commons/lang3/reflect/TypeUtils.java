...
import shaded.org.apache.commons.lang3.ClassUtils;
import shaded.org.apache.commons.lang3.ObjectUtils;
import shaded.org.apache.commons.lang3.Validate;
import shaded.org.apache.commons.lang3.builder.Builder;
...
public class TypeUtils {
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        private WildcardTypeImpl(final Type[] upperBounds, final Type[] lowerBounds) {
            this.upperBounds = shaded.org.apache.commons.lang3.ObjectUtils.defaultIfNull(upperBounds, shaded.org.apache.commons.lang3.ArrayUtils.EMPTY_TYPE_ARRAY);
            this.lowerBounds = shaded.org.apache.commons.lang3.ObjectUtils.defaultIfNull(lowerBounds, shaded.org.apache.commons.lang3.ArrayUtils.EMPTY_TYPE_ARRAY);
        }
    ...
    private static <T> StringBuilder appendAllTo(final StringBuilder builder, final String sep,
        ...
        shaded.org.apache.commons.lang3.Validate.notEmpty(shaded.org.apache.commons.lang3.Validate.noNullElements(types));
        if (types.length > 0) {
    ...
    private static void appendRecursiveTypes(final StringBuilder builder, final int[] recursiveTypeIndexes,
        ...
        final Type[] argumentsFiltered = shaded.org.apache.commons.lang3.ArrayUtils.removeAll(argumentTypes, recursiveTypeIndexes);
    ...
    private static boolean containsVariableTypeSameParametrizedTypeBound(final TypeVariable<?> typeVariable,
        ...
        return shaded.org.apache.commons.lang3.ArrayUtils.contains(typeVariable.getBounds(), parameterizedType);
    }
    ...
    private static Type[] extractTypeArgumentsFrom(final Map<TypeVariable<?>, Type> mappings, final TypeVariable<?>[] variables) {
        ...
        for (final TypeVariable<?> var : variables) {
            shaded.org.apache.commons.lang3.Validate.isTrue(mappings.containsKey(var), "missing argument mapping for %s", toString(var));
    ...
    private static int[] findRecursiveTypes(final ParameterizedType parameterizedType) {
        ...
        for (int i = 0; i < filteredArgumentTypes.length; i++) {
            if (filteredArgumentTypes[i] instanceof TypeVariable<?> && containsVariableTypeSameParametrizedTypeBound(
                ...
                indexesToRemove = shaded.org.apache.commons.lang3.ArrayUtils.add(indexesToRemove, i);
            }
        }
    ...
    private static Map<TypeVariable<?>, Type> getTypeArguments(Class<?> cls, final Class<?> toClass,
        ...
        if (cls.isPrimitive()) {
            ...
            cls = shaded.org.apache.commons.lang3.ClassUtils.primitiveToWrapper(cls);
        }
    ...
    private static boolean isAssignable(final Type type, final Class<?> toClass) {
        ...
        if (type instanceof Class<?>) {
            ...
            return shaded.org.apache.commons.lang3.ClassUtils.isAssignable((Class<?>) type, toClass);
        }
    ...
    public static Type[] normalizeUpperBounds(final Type[] bounds) {
        ...
        return types.toArray(shaded.org.apache.commons.lang3.ArrayUtils.EMPTY_TYPE_ARRAY);
    }
    ...
    public static final ParameterizedType parameterizeWithOwner(final Type owner, final Class<?> rawClass,
        ...
        if (rawClass.getEnclosingClass() == null) {
            shaded.org.apache.commons.lang3.Validate.isTrue(owner == null, "no owner allowed for top-level %s", rawClass);
            useOwner = null;
        } else if (owner == null) {
            useOwner = rawClass.getEnclosingClass();
        } else {
            shaded.org.apache.commons.lang3.Validate.isTrue(isAssignable(owner, rawClass.getEnclosingClass()),
                "%s is invalid owner type for parameterized %s", owner, rawClass);
            useOwner = owner;
        }
        shaded.org.apache.commons.lang3.Validate.noNullElements(typeArguments, "null type argument at index %s");
