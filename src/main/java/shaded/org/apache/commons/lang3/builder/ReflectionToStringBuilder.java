...
public class ReflectionToStringBuilder extends ToStringBuilder {
    ...
    protected boolean accept(final Field field) {
        ...
        if (shaded.org.apache.commons.lang3.ArrayUtils.isNotEmpty(includeFieldNames)) {
    ...
    protected void appendFieldsIn(final Class<?> clazz) {
        ...
        final Field[] fields = shaded.org.apache.commons.lang3.ArraySorter.sort(clazz.getDeclaredFields(), Comparator.comparing(Field::getName));
    ...
    public ReflectionToStringBuilder setExcludeFieldNames(final String... excludeFieldNamesParam) {
        if (excludeFieldNamesParam == null) {
            ...
            this.excludeFieldNames = shaded.org.apache.commons.lang3.ArraySorter.sort(toNoNullStringArray(excludeFieldNamesParam));
        }
        return this;
    }
