...
public class StrSubstitutor {
    ...
    public String replace(final String source) {
        ...
        final shaded.org.apache.commons.lang3.text.StrBuilder buf = new shaded.org.apache.commons.lang3.text.StrBuilder(source);
    ...
    public String replace(final String source, final int offset, final int length) {
        ...
        final shaded.org.apache.commons.lang3.text.StrBuilder buf = new shaded.org.apache.commons.lang3.text.StrBuilder(length).append(source, offset, length);
    ...
    public String replace(final char[] source) {
        ...
        final shaded.org.apache.commons.lang3.text.StrBuilder buf = new shaded.org.apache.commons.lang3.text.StrBuilder(source.length).append(source);
     ...
     * @return the result of the replace operation
     */
    public String replace(final shaded.org.apache.commons.lang3.text.StrBuilder source) {
        if (source == null) {
            return null;
        }
        final shaded.org.apache.commons.lang3.text.StrBuilder buf = new shaded.org.apache.commons.lang3.text.StrBuilder(source.length()).append(source);
     ...
     * @return the result of the replace operation
     */
    public String replace(final shaded.org.apache.commons.lang3.text.StrBuilder source, final int offset, final int length) {
        if (source == null) {
            return null;
        }
        final shaded.org.apache.commons.lang3.text.StrBuilder buf = new shaded.org.apache.commons.lang3.text.StrBuilder(length).append(source, offset, length);
    ...
    public String replace(final Object source) {
        ...
        final shaded.org.apache.commons.lang3.text.StrBuilder buf = new shaded.org.apache.commons.lang3.text.StrBuilder().append(source);
        substitute(buf, 0, buf.length());
        return buf.toString();
    }
     ...
     * @return true if altered
     */
    public boolean replaceIn(final shaded.org.apache.commons.lang3.text.StrBuilder source) {
        if (source == null) {
            return false;
        }
     ...
     * @return true if altered
     */
    public boolean replaceIn(final shaded.org.apache.commons.lang3.text.StrBuilder source, final int offset, final int length) {
        if (source == null) {
            return false;
        }
     ...
     * @return true if altered
     */
    protected boolean substitute(final shaded.org.apache.commons.lang3.text.StrBuilder buf, final int offset, final int length) {
     ...
     */
    private int substitute(final shaded.org.apache.commons.lang3.text.StrBuilder buf, final int offset, final int length, List<String> priorVariables) {
                    ...
                    if (endMatchLen == 0) {
                        ...
                        if (nestedVarCount == 0) {
                            String varNameExpr = new String(chars, startPos
                                    ...
                                    - startMatchLen);
                            if (substitutionInVariablesEnabled) {
                                final shaded.org.apache.commons.lang3.text.StrBuilder bufName = new shaded.org.apache.commons.lang3.text.StrBuilder(varNameExpr);
    ...
    private void checkCyclicSubstitution(final String varName, final List<String> priorVariables) {
        ...
        final shaded.org.apache.commons.lang3.text.StrBuilder buf = new shaded.org.apache.commons.lang3.text.StrBuilder(256);
