...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    protected List<String> tokenize(final char[] srcChars, final int offset, final int count) {
        ...
        final shaded.org.apache.commons.lang3.text.StrBuilder buf = new shaded.org.apache.commons.lang3.text.StrBuilder();
     ...
     */
    private int readNextToken(final char[] srcChars, int start, final int len, final shaded.org.apache.commons.lang3.text.StrBuilder workArea, final List<String> tokenList) {
