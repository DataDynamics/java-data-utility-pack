...
public class Failable {
     ...
     */
    public static <T, U, E extends Throwable> void accept(final shaded.org.apache.commons.lang3.function.FailableBiConsumer<T, U, E> consumer, final T object1,
                                                          final U object2) {
     ...
     */
    public static <T, U, R, E extends Throwable> R apply(final shaded.org.apache.commons.lang3.function.FailableBiFunction<T, U, R, E> function, final T input1,
                                                         final U input2) {
    ...
    /**
     * Converts the given {@link shaded.org.apache.commons.lang3.function.FailableBiConsumer} into a standard {@link BiConsumer}.
     *
    ...
    /**
     * Converts the given {@link shaded.org.apache.commons.lang3.function.FailableBiFunction} into a standard {@link BiFunction}.
     *
     ...
     * @param function a {@link shaded.org.apache.commons.lang3.function.FailableBiFunction}
    ...
    /**
     * Converts the given collection into a {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream}. The {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream} consists of the
     ...
     * </pre>
     *
     * @param collection The collection, which is being converted into a {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream}.
     * @param <E> The collections element type. (In turn, the result streams element type.)
     * @return The created {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream}.
     */
    public static <E> shaded.org.apache.commons.lang3.stream.Streams.FailableStream<E> stream(final Collection<E> collection) {
        return new shaded.org.apache.commons.lang3.stream.Streams.FailableStream<>(collection.stream());
    }

    /**
     * Converts the given stream into a {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream}. The {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream} consists of the same
     ...
     *
     * @param stream The stream, which is being converted into a {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream}.
     * @param <T> The streams element type.
     * @return The created {@link shaded.org.apache.commons.lang3.stream.Streams.FailableStream}.
     */
    public static <T> shaded.org.apache.commons.lang3.stream.Streams.FailableStream<T> stream(final Stream<T> stream) {
        return new shaded.org.apache.commons.lang3.stream.Streams.FailableStream<>(stream);
    }
    ...
    public static void tryWithResources(final FailableRunnable<? extends Throwable> action,
        ...
        shaded.org.apache.commons.lang3.stream.Streams.of(resources).forEach(r -> Objects.requireNonNull(r, "runnable"));
        Throwable th = null;
        try {
            action.run();
        } catch (final Throwable t) {
