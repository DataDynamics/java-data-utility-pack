...
public class Validate {
    ...
    public static <T> T[] noNullElements(final T[] array, final String message, final Object... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            if (array[i] == null) {
                final Object[] values2 = shaded.org.apache.commons.lang3.ArrayUtils.add(values, Integer.valueOf(i));
    ...
    public static <T extends Iterable<?>> T noNullElements(final T iterable, final String message, final Object... values) {
        ...
        for (final Iterator<?> it = iterable.iterator(); it.hasNext(); i++) {
            if (it.next() == null) {
                final Object[] values2 = shaded.org.apache.commons.lang3.ArrayUtils.addAll(values, Integer.valueOf(i));
                throw new IllegalArgumentException(getMessage(message, values2));
            }
        }
        return iterable;
    ...
    public static void isInstanceOf(final Class<?> type, final Object obj) {
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, type.getName(), shaded.org.apache.commons.lang3.ClassUtils.getName(obj, "null")));
        }
    }
    ...
    public static void isAssignableFrom(final Class<?> superType, final Class<?> type) {
        ...
        if (type == null || superType == null || !superType.isAssignableFrom(type)) {
            throw new IllegalArgumentException(
                String.format(DEFAULT_IS_ASSIGNABLE_EX_MESSAGE, shaded.org.apache.commons.lang3.ClassUtils.getName(type, "null type"), ClassUtils.getName(superType, "null type")));
        }
    }
