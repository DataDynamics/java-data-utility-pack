...
import shaded.org.apache.commons.lang3.builder.EqualsBuilder;
...
public class ArrayUtils {
    ...
    public static <T> T[] add(final T[] array, final int index, final T element) {
        ...
        if (array != null) {
            ...
            clss = shaded.org.apache.commons.lang3.ObjectUtils.getClass(element);
        } else {
    ...
    public static <T> Class<T> getComponentType(final T[] array) {
        return shaded.org.apache.commons.lang3.ClassUtils.getComponentType(ObjectUtils.getClass(array));
    }
    ...
    public static boolean isSorted(final byte[] array) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            if (shaded.org.apache.commons.lang3.math.NumberUtils.compare(previous, current) > 0) {
                return false;
            }
