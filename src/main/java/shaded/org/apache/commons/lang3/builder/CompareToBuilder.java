 ...
 * {@code hashCode()} built with {@link shaded.org.apache.commons.lang3.builder.EqualsBuilder} and
 ...
 * @see Object#hashCode()
 * @see EqualsBuilder
 * @see shaded.org.apache.commons.lang3.builder.HashCodeBuilder
 * @since 1.0
 */
    ...
    private static void reflectionAppend(
        ...
        for (int i = 0; i < fields.length && builder.comparison == 0; i++) {
            ...
            if (!ArrayUtils.contains(excludeFields, field.getName())
                ...
                builder.append(shaded.org.apache.commons.lang3.builder.Reflection.getUnchecked(field, lhs), shaded.org.apache.commons.lang3.builder.Reflection.getUnchecked(field, rhs));
            }
        }
    }
