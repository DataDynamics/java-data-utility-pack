...
public class ConcurrentUtils {
     ...
     * creates a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentException} with the checked cause if
     ...
     * creates a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentException}, initializes it with the cause, and
     * returns it.</li>
     * </ul>
     *
     * @param ex the exception to be processed
     * @return a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentException} with the checked cause
     */
    public static shaded.org.apache.commons.lang3.concurrent.ConcurrentException extractCause(final ExecutionException ex) {
        if (ex == null || ex.getCause() == null) {
            return null;
        }
        ExceptionUtils.throwUnchecked(ex.getCause());
        return new shaded.org.apache.commons.lang3.concurrent.ConcurrentException(ex.getMessage(), ex.getCause());
    }

    /**
     * Inspects the cause of the specified {@link ExecutionException} and
     * creates a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException} with the checked cause if
     ...
     *
     * @param ex the exception to be processed
     * @return a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException} with the checked cause
     */
    public static shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException extractCauseUnchecked(
        ...
        ExceptionUtils.throwUnchecked(ex.getCause());
        return new shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException(ex.getMessage(), ex.getCause());
    }
     ...
     * in a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentException}, which is thrown. If the passed in
     * exception is <b>null</b> or has no cause, the method simply returns
     * without throwing an exception.
     *
     * @param ex the exception to be handled
     * @throws shaded.org.apache.commons.lang3.concurrent.ConcurrentException if the cause of the {@code
     * ExecutionException} is a checked exception
     */
    public static void handleCause(final ExecutionException ex)
            throws shaded.org.apache.commons.lang3.concurrent.ConcurrentException {
        final shaded.org.apache.commons.lang3.concurrent.ConcurrentException cex = extractCause(ex);
     ...
     * {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentException} it throws a
     * {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException}. This is an alternative for client
     * code that does not want to deal with checked exceptions.
     *
     * @param ex the exception to be handled
     * @throws shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException if the cause of the {@code
    ...
    public static void handleCauseUnchecked(final ExecutionException ex) {
        final shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException crex = extractCauseUnchecked(ex);
    ...
    /**
     * Invokes the specified {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer} and returns the
     * object produced by the initializer. This method just invokes the {@code
     * get()} method of the given {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer}. It is
     * <b>null</b>-safe: if the argument is <b>null</b>, result is also
     * <b>null</b>.
     *
     * @param <T> the type of the object produced by the initializer
     * @param initializer the {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer} to be invoked
     * @return the object managed by the {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer}
     * @throws shaded.org.apache.commons.lang3.concurrent.ConcurrentException if the {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer} throws
     * an exception
     */
    public static <T> T initialize(final shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer<T> initializer)
            throws shaded.org.apache.commons.lang3.concurrent.ConcurrentException {
        return initializer != null ? initializer.get() : null;
    }

    /**
     * Invokes the specified {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer} and transforms
     * occurring exceptions to runtime exceptions. This method works like
     * {@link #initialize(shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer)}, but if the {@code
     * ConcurrentInitializer} throws a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentException}, it is
     * caught, and the cause is wrapped in a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException}.
     * So client code does not have to deal with checked exceptions.
     *
     * @param <T> the type of the object produced by the initializer
     * @param initializer the {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer} to be invoked
     * @return the object managed by the {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer}
     * @throws shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException if the initializer throws an exception
     */
    public static <T> T initializeUnchecked(final shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer<T> initializer) {
        try {
            return initialize(initializer);
        } catch (final shaded.org.apache.commons.lang3.concurrent.ConcurrentException cex) {
            throw new shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException(cex.getCause());
        }
    }
     ...
     * the {@code get()} method of the passed in {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer}
     ...
     * @param map the map to be modified
     * @param key the key of the value to be added
     * @param init the {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer} for creating the value
     * @return the value stored in the map after this operation; this may or may
     * not be the object created by the {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer}
     * @throws shaded.org.apache.commons.lang3.concurrent.ConcurrentException if the initializer throws an exception
     */
    public static <K, V> V createIfAbsent(final ConcurrentMap<K, V> map, final K key,
            final shaded.org.apache.commons.lang3.concurrent.ConcurrentInitializer<V> init) throws shaded.org.apache.commons.lang3.concurrent.ConcurrentException {
     ...
     * {@code createIfAbsent()}. If a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentException} is thrown, it
     * is caught and re-thrown as a {@link shaded.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException}.
     *
     * @param <K> the type of the keys of the map
     * @param <V> the type of the values of the map
     * @param map the map to be modified
