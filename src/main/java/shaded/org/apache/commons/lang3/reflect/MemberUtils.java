...
final class MemberUtils {
    ...
    private static float getObjectTransformationCost(Class<?> srcClass, final Class<?> destClass) {
        ...
        while (srcClass != null && !destClass.equals(srcClass)) {
            if (destClass.isInterface() && shaded.org.apache.commons.lang3.ClassUtils.isAssignable(srcClass, destClass)) {
    ...
    private static float getPrimitivePromotionCost(final Class<?> srcClass, final Class<?> destClass) {
        ...
        if (!cls.isPrimitive()) {
            ...
            cost += 0.1f;
            cls = shaded.org.apache.commons.lang3.ClassUtils.wrapperToPrimitive(cls);
        }
    ...
    private static boolean isMatchingExecutable(final Executable method, final Class<?>[] parameterTypes) {
        ...
        if (shaded.org.apache.commons.lang3.ClassUtils.isAssignable(parameterTypes, methodParameterTypes, true)) {
            return true;
        }
        ...
        if (method.isVarArgs()) {
            ...
            for (i = 0; i < methodParameterTypes.length - 1 && i < parameterTypes.length; i++) {
                if (!shaded.org.apache.commons.lang3.ClassUtils.isAssignable(parameterTypes[i], methodParameterTypes[i], true)) {
                    return false;
                }
            }
