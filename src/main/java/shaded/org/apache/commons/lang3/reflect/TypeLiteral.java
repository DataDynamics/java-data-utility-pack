 ...
 * </p>
 * <p>Additionally {@link TypeLiteral} implements the {@link shaded.org.apache.commons.lang3.reflect.Typed} interface which
...
public abstract class TypeLiteral<T> implements Typed<T> {
    ...
    protected TypeLiteral() {
        this.value =
            Validate.notNull(shaded.org.apache.commons.lang3.reflect.TypeUtils.getTypeArguments(getClass(), TypeLiteral.class).get(T),
                "%s does not assign type parameter %s", getClass(), shaded.org.apache.commons.lang3.reflect.TypeUtils.toLongString(T));

        this.toString = String.format("%s<%s>", TypeLiteral.class.getSimpleName(), shaded.org.apache.commons.lang3.reflect.TypeUtils.toString(value));
    }
