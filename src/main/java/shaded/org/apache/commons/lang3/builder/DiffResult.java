 ...
 * {@link shaded.org.apache.commons.lang3.builder.Diffable} objects. Typically these differences are displayed using
 ...
 * @since 3.3
 */
public class DiffResult<T> implements Iterable<shaded.org.apache.commons.lang3.builder.Diff<?>> {
    ...
    private final List<shaded.org.apache.commons.lang3.builder.Diff<?>> diffList;
    private final T lhs;
    private final T rhs;
     ...
     */
    DiffResult(final T lhs, final T rhs, final List<shaded.org.apache.commons.lang3.builder.Diff<?>> diffList,
    ...
    /**
     * Returns an unmodifiable list of {@link shaded.org.apache.commons.lang3.builder.Diff}s. The list may be empty if
     * there were no differences between the objects.
     *
     * @return an unmodifiable list of {@link shaded.org.apache.commons.lang3.builder.Diff}s
     */
    public List<shaded.org.apache.commons.lang3.builder.Diff<?>> getDiffs() {
    ...
    /**
     * Returns an iterator over the {@link shaded.org.apache.commons.lang3.builder.Diff} objects contained in this list.
     *
     * @return the iterator
     */
    @Override
