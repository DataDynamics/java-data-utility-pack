 ...
 * to {@link shaded.org.apache.commons.lang3.concurrent.AtomicInitializer}, but ensures that the {@link #initialize()}
 * method is called only once.
 *
 * <p>
 * As {@link shaded.org.apache.commons.lang3.concurrent.AtomicInitializer} this class is based on atomic variables, so it
 ...
 * efficient than {@link shaded.org.apache.commons.lang3.concurrent.AtomicInitializer}, but if the object creation in the
