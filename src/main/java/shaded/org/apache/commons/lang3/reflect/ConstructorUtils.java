...
public class ConstructorUtils {
    ...
    public static <T> T invokeConstructor(final Class<T> cls, Object... args)
        ...
        return invokeConstructor(cls, args, shaded.org.apache.commons.lang3.ClassUtils.toClass(args));
    }
    ...
    public static <T> T invokeExactConstructor(final Class<T> cls, Object... args)
            ...
            InstantiationException {
        args = shaded.org.apache.commons.lang3.ArrayUtils.nullToEmpty(args);
        return invokeExactConstructor(cls, args, shaded.org.apache.commons.lang3.ClassUtils.toClass(args));
    }
