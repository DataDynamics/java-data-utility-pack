...
import shaded.org.apache.commons.lang3.exception.UncheckedInterruptedException;
...
public interface UncheckedFuture<V> extends Future<V> {
    ...
    static <T> UncheckedFuture<T> on(final Future<T> future) {
        return new shaded.org.apache.commons.lang3.concurrent.UncheckedFutureImpl<>(future);
    }
     ...
     * <li>{@link ExecutionException} \u2192 {@link shaded.org.apache.commons.lang3.concurrent.UncheckedExecutionException}</li>
     * </ul>
     */
    @Override
    V get();
