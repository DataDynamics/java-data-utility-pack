...
import shaded.org.apache.commons.lang3.exception.UncheckedIllegalAccessException;
...
public final class MethodInvokers {
    ...
    /**
     * Produces a {@link shaded.org.apache.commons.lang3.function.FailableBiConsumer} for a given <em>consumer</em> Method. For example, a classic setter method (as
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T, U> shaded.org.apache.commons.lang3.function.FailableBiConsumer<T, U, Throwable> asFailableBiConsumer(final Method method) {
        return asInterfaceInstance(FailableBiConsumer.class, method);
    }

    /**
     * Produces a {@link shaded.org.apache.commons.lang3.function.FailableBiFunction} for a given a <em>function</em> Method. You call the FailableBiFunction with
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T, U, R> shaded.org.apache.commons.lang3.function.FailableBiFunction<T, U, R, Throwable> asFailableBiFunction(final Method method) {
        return asInterfaceInstance(FailableBiFunction.class, method);
    }

    /**
     * Produces a {@link shaded.org.apache.commons.lang3.function.FailableFunction} for a given a <em>supplier</em> Method. You call the Function with one argument:
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T, R> shaded.org.apache.commons.lang3.function.FailableFunction<T, R, Throwable> asFailableFunction(final Method method) {
        return asInterfaceInstance(FailableFunction.class, method);
    }

    /**
     * Produces a {@link shaded.org.apache.commons.lang3.function.FailableSupplier} for a given a <em>supplier</em> Method. The FailableSupplier return type must
     * match the method's return type.
     * <p>
     ...
     */
    @SuppressWarnings("unchecked")
    public static <R> shaded.org.apache.commons.lang3.function.FailableSupplier<R, Throwable> asFailableSupplier(final Method method) {
