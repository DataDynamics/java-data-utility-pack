...
public class FileUtils {
    ...
    public static void copy(byte[] bytes, OutputStream outputStream) throws IOException {
     ...
     * @param name   파일명
     * @return 임시 파일
     * @throws IOException 임시 파일을 생성할 수 없는 경우
     */
     ...
     * @param name   디렉토리명
     * @return 임시 디렉토리
     * @throws IOException 임시 디렉토리를 생성할 수 없는 경우
     */
     ...
     * @param dir    디렉토리 여부
     * @return 디렉토리 또는 파일
     * @throws IOException 디렉토리를 생성할 수 없는 경우
     */
